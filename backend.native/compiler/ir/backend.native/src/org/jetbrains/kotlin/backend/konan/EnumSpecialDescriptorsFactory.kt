...
internal class EnumSpecialDeclarationsFactory(val context: Context) {
    fun createLoweredEnum(enumClass: IrClass): LoweredEnum {
        ...
        val valuesField = IrFieldImpl(startOffset, endOffset, DECLARATION_ORIGIN_ENUM, valuesProperty, context.ir.symbols.array.defaultType) // FIXME: substitute
        ...
        val valuesGetter = IrFunctionImpl(startOffset, endOffset, DECLARATION_ORIGIN_ENUM, valuesGetterDescriptor).also {
            it.returnType = context.ir.symbols.array.defaultType
        }
        ...
        // TODO: why primary?
        val constructor = implObject.addSimpleDelegatingConstructor(constructorOfAny, context.irBuiltIns, true)
        ...
        implObject.setSuperSymbols(listOf(context.ir.symbols.any.owner))

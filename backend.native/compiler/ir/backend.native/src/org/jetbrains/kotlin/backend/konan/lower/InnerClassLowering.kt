            ...
            if (irConstructor.callsSuper()) {
                ...
                blockBody.statements.add(
                        ...
                        IrSetFieldImpl(
                                ...
                                IrGetValueImpl(startOffset, endOffset, irConstructor.dispatchReceiverParameter!!.type, irConstructor.dispatchReceiverParameter!!.symbol),
                                context.ir.symbols.unit.defaultType
                        )
                )
            }

...
internal object EscapeAnalysis {
     ...
     *    are already handled).
     * 3. For a SCC build the points-to graph iteratively starting with empty graph
                    ...
                    if (caller != null) {
                        ...
                        if (!callee.isOverridable || expression !is IrCall || expression.superQualifier != null) {
                            ...
                            val actualCallees = possibleReceiverTypes.map {
                                ...
                                DEBUG_OUTPUT(0) { println("Actual receiver type: $it") }
                                ...
                                DEBUG_OUTPUT(0) { println("Actual callee: $actualCallee") }

                                actualCallee
                            }
                            if (actualCallees.any { it.isOverridable }) {

                                DEBUG_OUTPUT(0) { println("An actual virtual call") }

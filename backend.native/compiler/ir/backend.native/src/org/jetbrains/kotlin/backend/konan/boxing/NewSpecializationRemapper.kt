...
internal class NewReplaceOriginsWithSpecializationsLowering(val context: Context) : FileLoweringPass {

    override fun lower(irFile: IrFile) {
        irFile.transform(NewSpecializationRemapper(context), data = null)
    }
}

internal class NewSpecializationRemapper(
        val context: Context,
        private val symbolRemapper: SymbolRemapperForReplacer = SymbolRemapperForReplacer(),
...
internal class SymbolRemapperForReplacer(
...
internal class TypeRemapperForReplacer : TypeRemapper {

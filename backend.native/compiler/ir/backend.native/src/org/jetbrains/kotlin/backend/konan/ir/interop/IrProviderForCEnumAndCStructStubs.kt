...
internal class IrProviderForCEnumAndCStructStubs(
    ...
    fun canHandleSymbol(symbol: IrSymbol): Boolean {
        ...
        // If symbol is pointing to declaration that should not be generated
        // (e.g. declarations from cached dependencies) then fallback to default
        // behavior instead (lazy IR generation).

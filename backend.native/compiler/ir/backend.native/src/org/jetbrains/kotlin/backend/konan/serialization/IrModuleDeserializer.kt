...
abstract class IrModuleDeserializer(
    ...
    private fun deserializeName(proto: KonanIr.String): Name {
    ...
    open fun deserializeDeclaration(proto: KonanIr.IrDeclaration, parent: IrDeclarationParent?): IrDeclaration {

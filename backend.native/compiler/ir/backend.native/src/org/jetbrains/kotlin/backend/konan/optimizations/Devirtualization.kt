...
import org.jetbrains.kotlin.backend.konan.irasdescriptors.explicitParameters
                ...
                irBuilder.run {
                    ...
                    return when {
                        possibleCallees.isEmpty() -> irBlock(expression) {
                            +irCall(context.ir.symbols.throwInvalidReceiverTypeException.owner).apply {
                            ...
                            +nullConst(expression, type, context)
                        }
                        ...
                        optimize && possibleCallees.size == 1 -> { // Monomorphic callsite.
                            ...
                            possibleCallees.mapIndexedTo(branches) { index, devirtualizedCallee ->
                                ...
                                val expectedTypeInfo = IrPrivateClassReferenceImpl(
                                        startOffset      = startOffset,
                                        endOffset        = endOffset,
                                        type             = context.ir.symbols.nativePtr.defaultType,

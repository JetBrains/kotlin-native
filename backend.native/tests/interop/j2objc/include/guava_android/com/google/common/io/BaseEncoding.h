...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/io/BaseEncoding.java
//
...
- (instancetype __nonnull)initWithComGoogleCommonIoBaseEncoding_Alphabet:(ComGoogleCommonIoBaseEncoding_Alphabet * __nonnull)arg0
                                                   withJavaLangCharacter:(JavaLangCharacter * __nonnull)arg1 NS_UNAVAILABLE;

- (instancetype __nonnull)initWithNSString:(NSString * __nonnull)arg0
                              withNSString:(NSString * __nonnull)arg1
                     withJavaLangCharacter:(JavaLangCharacter * __nonnull)arg2 NS_UNAVAILABLE;

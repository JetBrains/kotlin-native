...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/reflect/Parameter.java
//
...
- (id<JavaLangAnnotationAnnotation> __nullable)getAnnotationWithIOSClass:(IOSClass * __nonnull)annotationType;
...
/*!
 @since 18.0
 */
- (id<JavaLangAnnotationAnnotation> __nullable)getDeclaredAnnotationWithIOSClass:(IOSClass * __nonnull)annotationType;

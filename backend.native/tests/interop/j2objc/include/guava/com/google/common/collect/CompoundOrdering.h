...
- (instancetype __nonnull)initPackagePrivateWithJavaUtilComparator:(id<JavaUtilComparator>)primary
                                            withJavaUtilComparator:(id<JavaUtilComparator>)secondary;

- (instancetype __nonnull)initPackagePrivateWithJavaLangIterable:(id<JavaLangIterable>)comparators;

...
- (instancetype __nonnull)initPackagePrivateWithComGoogleCommonCollectTable_Cell:(id<ComGoogleCommonCollectTable_Cell>)cell;

- (instancetype __nonnull)initPackagePrivateWithId:(id)rowKey
                                            withId:(id)columnKey
                                            withId:(id)value;

...
- (instancetype __nonnull)initPackagePrivateWithComGoogleCommonCollectImmutableMap:(ComGoogleCommonCollectImmutableMap *)rankMap;

- (instancetype __nonnull)initPackagePrivateWithJavaUtilList:(id<JavaUtilList>)valuesInOrder;

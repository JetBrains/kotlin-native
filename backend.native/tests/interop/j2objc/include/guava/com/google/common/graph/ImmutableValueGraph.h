 ...
 */
+ (ComGoogleCommonGraphImmutableValueGraph *)copyOfWithComGoogleCommonGraphImmutableValueGraph:(ComGoogleCommonGraphImmutableValueGraph *)graph OBJC_METHOD_FAMILY_NONE __attribute__((deprecated));
...
- (instancetype __nonnull)initPackagePrivateWithComGoogleCommonGraphAbstractGraphBuilder:(ComGoogleCommonGraphAbstractGraphBuilder *)arg0 NS_UNAVAILABLE;

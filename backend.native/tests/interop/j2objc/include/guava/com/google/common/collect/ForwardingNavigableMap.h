...
/*!
 @brief Constructor for use by subclasses.
 */
- (instancetype __nonnull)initWithComGoogleCommonCollectForwardingNavigableMap:(ComGoogleCommonCollectForwardingNavigableMap *)outer$;
...
- (instancetype __nonnull)initWithJavaUtilNavigableMap:(id<JavaUtilNavigableMap>)arg0 NS_UNAVAILABLE;

...
- (instancetype __nonnull)initWithComGoogleCommonCollectImmutableMultiset:(ComGoogleCommonCollectImmutableMultiset *)multiset;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectMultiset:(id<ComGoogleCommonCollectMultiset>)contents;
...
- (instancetype __nonnull)initWithJavaUtilList:(id<JavaUtilList>)entries

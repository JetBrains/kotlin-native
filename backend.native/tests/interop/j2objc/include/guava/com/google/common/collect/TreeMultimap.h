...
- (instancetype __nonnull)initWithJavaUtilComparator:(id<JavaUtilComparator>)keyComparator
                              withJavaUtilComparator:(id<JavaUtilComparator>)valueComparator;
...
- (instancetype __nonnull)initPackagePrivateWithJavaUtilSortedMap:(id<JavaUtilSortedMap>)arg0 NS_UNAVAILABLE;

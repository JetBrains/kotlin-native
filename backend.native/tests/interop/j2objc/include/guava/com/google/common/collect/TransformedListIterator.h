...
- (instancetype __nonnull)initPackagePrivateWithJavaUtilListIterator:(id<JavaUtilListIterator>)backingIterator;

// Disallowed inherited constructors, do not use.

- (instancetype __nonnull)initPackagePrivateWithJavaUtilIterator:(id<JavaUtilIterator>)arg0 NS_UNAVAILABLE;

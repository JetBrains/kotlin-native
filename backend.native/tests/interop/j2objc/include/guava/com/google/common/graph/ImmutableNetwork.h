 ...
 */
+ (ComGoogleCommonGraphImmutableNetwork *)copyOfWithComGoogleCommonGraphImmutableNetwork:(ComGoogleCommonGraphImmutableNetwork *)network OBJC_METHOD_FAMILY_NONE __attribute__((deprecated));
...
- (instancetype __nonnull)initPackagePrivateWithComGoogleCommonGraphNetworkBuilder:(ComGoogleCommonGraphNetworkBuilder *)arg0 NS_UNAVAILABLE;

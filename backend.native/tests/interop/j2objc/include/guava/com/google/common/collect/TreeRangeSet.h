...
- (ComGoogleCommonCollectRange * __nullable)rangeContainingWithJavaLangComparable:(id<JavaLangComparable>)value;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectTreeRangeSet:(ComGoogleCommonCollectTreeRangeSet *)outer$
...
- (instancetype __nonnull)initWithJavaUtilNavigableMap:(id<JavaUtilNavigableMap>)rangesByLowerBound;

...
/*!
 ...
 @since 21.0
 */
+ (ComGoogleCommonBaseOptional * __nullable)fromJavaUtilWithJavaUtilOptional:(JavaUtilOptional * __nonnull)javaUtilOptional;
 ...
 */
+ (ComGoogleCommonBaseOptional *)fromNullableWithId:(id __nonnull)nullableReference;

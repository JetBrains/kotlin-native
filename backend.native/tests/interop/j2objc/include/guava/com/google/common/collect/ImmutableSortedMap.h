...
- (instancetype __nonnull)initWithComGoogleCommonCollectRegularImmutableSortedSet:(ComGoogleCommonCollectRegularImmutableSortedSet *)keySet
...
/*!
 ...
 @since 19.0
 */
- (ComGoogleCommonCollectImmutableSortedMap_Builder *)orderEntriesByValueWithJavaUtilComparator:(id<JavaUtilComparator>)valueComparator __attribute__((deprecated));

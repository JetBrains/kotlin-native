...
- (instancetype __nonnull)initWithId:(id)rowKey
                              withId:(id)columnKey
                              withId:(id)value;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectTable:(id<ComGoogleCommonCollectTable>)delegate;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectRowSortedTable:(id<ComGoogleCommonCollectRowSortedTable>)delegate;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectTable:(id<ComGoogleCommonCollectTable>)arg0 NS_UNAVAILABLE;

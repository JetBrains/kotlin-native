...
fun testBoxingSimple() {
    ...
    val box: Box<VectorFloat4> = Box<VectorFloat4>(v)
    assertEquals(v, box.value, "testBoxingSimple FAILED")
}

fun testBoxing() {
    var u = UnalignedC(genericVectorOf(0, 1, 2, 3))
    assertEquals(3, u.value.getIntAt(3))
    u.value = genericVectorOf(0f, 1f, 2f, 3f)
    assertEquals(genericVectorOf(0f, 1f, 2f, 3f), u.value, "testBoxing FAILED")
}

fun testSetGet() {
    var v4any = genericVectorOf(0, 1, 2, 3)
    ...
    v4any = genericVectorOf(a[0], a[1], a[2], a[3])
...
fun testString2() {
    val v4f = vectorOf(1.0f, 2.0f, 0.5f, -0.5f)
    assertEquals("(1.0, 2.0, 0.5, -0.5)", v4f.toString(), "testString FAILED")
}

fun testOOB() {
    val f = genericVectorOf(1f, 3.162f, 10f, 31f)
...
fun testEquals() {
    var v1 = genericVectorOf(-1f, 0f, 0f, -7f)
    var v2 = genericVectorOf(1f, 4f, 3f, 7f)
    ...
    var v3 = vectorOf(1, 2, 3)
    var v4 = vectorOf(1, 2, 2)
    assertTrue(v3 != v4)
    v4 = vectorOf(1, 2, 3)
    assertEquals(v3, v4)
}
...
fun testHash() {
    ...
    val i = 654687
    assertEquals(true, genericVectorOf(0, 0, i, 0).hashCode() == i.hashCode())  // exploit little endianness
    assertEquals(true, genericVectorOf(1, 0, 0, 0).hashCode() == genericVectorOf(0, 0, 31, 0).hashCode())
}

private fun funDefaultValue(v: Vector128 = genericVectorOf(1.0f, 2.0f, 3.0f, 4.0f)) = v

fun testDefaultValue() {
    assertEquals(genericVectorOf(1.0f, 2.0f, 3.0f, 4.0f), funDefaultValue())
}

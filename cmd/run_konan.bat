...
set "KOTLIN_IDL2K_JAR=%KONAN_LIB%\idl2k.jar"
set "ANTLR_JAR=%KONAN_LIB%\antlr4-runtime.jar"
...
set "KONAN_CLASSPATH=%KOTLIN_JAR%;%KOTLIN_STDLIB_JAR%;%KOTLIN_REFLECT_JAR%;%KOTLIN_SCRIPT_RUNTIME_JAR%;%INTEROP_RUNTIME_JAR%;%KONAN_JAR%;%STUB_GENERATOR_JAR%;%INTEROP_INDEXER_JAR%;%SHARED_JAR%;%KLIB_JAR%;%UTILITIES_JAR%;%EXTRACTED_METADATA_JAR%;%EXTRACTED_SERIALIZER_JAR%;%KOTLIN_IDL2K_JAR%;%ANTLR_JAR%"

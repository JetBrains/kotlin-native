...
* All heap-allocated classes should publicly inherit from `KonanAllocatorAware` with CRTP (i.e. `class A` should inherit from `KonanAllocatorAware<A>`). **TODO**: revisit after allocator substitution discussion.

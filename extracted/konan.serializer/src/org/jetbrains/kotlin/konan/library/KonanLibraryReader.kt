...
val KonanLibraryReader.uniqueName
    get() = manifestProperties.getProperty(KLIB_PROPERTY_UNIQUE_NAME)!!

val KonanLibraryReader.unresolvedDependencies: List<String>
    get() = manifestProperties.propertyList(KLIB_PROPERTY_DEPENDS)

val KonanLibraryReader.isInterop
    get() = manifestProperties.getProperty(KLIB_PROPERTY_INTEROP) == "true"

val KonanLibraryReader.packageFqName
    get() = manifestProperties.getProperty(KLIB_PROPERTY_PACKAGE)?.let { FqName(it) }

val KonanLibraryReader.exportForwardDeclarations
...
val KonanLibraryReader.includedHeaders

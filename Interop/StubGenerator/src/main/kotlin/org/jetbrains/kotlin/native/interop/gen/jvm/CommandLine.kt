...
fun getCInteropArguments(): List<OptionDescriptor> {
    val options = listOf(
            ...
            OptionDescriptor(ArgType.String(), "compilerOpts",
                    description = "additional compiler options (allow add several options divided by spaces)",
                    isMultiple = true, delimiter = " "),
            OptionDescriptor(ArgType.String(), "linkerOpts",
                    description = "additional linker options (allow add several options divided by spaces)",
                    isMultiple = true, delimiter = " "),
            ...
            OptionDescriptor(ArgType.String(), "copt", description = "additional compiler options (allow add several options divided by spaces)",
                    isMultiple = true, delimiter = " ", deprecatedWarning = "Option -copt is deprecated. Please use -compilerOpts."),
            OptionDescriptor(ArgType.String(), "lopt", description = "additional linker options (allow add several options divided by spaces)",

// TODO: For some reason these includes disappear during updating prebuilts
#include <stdint.h>
#include <jni.h>
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge318 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
    return (jint)isVector(*(CXType*)p0);
}
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge319 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
    return (jint)isExtVector(*(CXType*)p0);
}

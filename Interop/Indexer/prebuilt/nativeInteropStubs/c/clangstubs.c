...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge188 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge195 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge197 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge203 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2, jlong p3) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge206 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jint p2, jlong p3) {
    CXSourceRange kniStructResult = clang_Cursor_getSpellingNameRange(*(CXCursor*)p0, p1, p2);
    memcpy(p3, &kniStructResult, sizeof(kniStructResult));
}
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge207 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1) {
    return (jint)clang_PrintingPolicy_getProperty((void*)p0, p1);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge208 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jint p2) {
    clang_PrintingPolicy_setProperty((void*)p0, p1, p2);
}
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge209 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
    return (jlong)clang_getCursorPrintingPolicy(*(CXCursor*)p0);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge210 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge217 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge226 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2, jlong p3) {
...
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge234 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge240 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
    return (jint)clang_Module_getNumTopLevelHeaders((struct CXTranslationUnitImpl*)p0, (void*)p1);
}
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge241 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jint p2) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge255 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
    CXCursor kniStructResult = clang_getSpecializedCursorTemplate(*(CXCursor*)p0);
    memcpy(p1, &kniStructResult, sizeof(kniStructResult));
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge256 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jint p2, jlong p3) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge262 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2, jlong p3) {
    clang_tokenize((struct CXTranslationUnitImpl*)p0, *(CXSourceRange*)p1, (CXToken**)p2, (unsigned int*)p3);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge263 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jint p2, jlong p3) {
    clang_annotateTokens((struct CXTranslationUnitImpl*)p0, (CXToken*)p1, p2, (CXCursor*)p3);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge264 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jint p2) {
    clang_disposeTokens((struct CXTranslationUnitImpl*)p0, (CXToken*)p1, p2);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge265 (JNIEnv* jniEnv, jclass jclss, jint p0, jlong p1) {
    CXString kniStructResult = clang_getCursorKindSpelling(p0);
    memcpy(p1, &kniStructResult, sizeof(kniStructResult));
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge266 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2, jlong p3, jlong p4, jlong p5, jlong p6) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge267 (JNIEnv* jniEnv, jclass jclss) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge269 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1) {
    return (jint)clang_getCompletionChunkKind((void*)p0, p1);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge270 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2) {
    CXString kniStructResult = clang_getCompletionChunkText((void*)p0, p1);
    memcpy(p2, &kniStructResult, sizeof(kniStructResult));
}
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge271 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge276 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge278 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge281 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jint p2, jlong p3, jlong p4) {
    CXString kniStructResult = clang_getCompletionFixIt((CXCodeCompleteResults*)p0, p1, p2, (CXSourceRange*)p3);
    memcpy(p4, &kniStructResult, sizeof(kniStructResult));
}
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge282 (JNIEnv* jniEnv, jclass jclss) {
    return (jint)clang_defaultCodeCompleteOptions();
}
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge283 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jint p2, jint p3, jlong p4, jint p5, jint p6) {
    return (jlong)clang_codeCompleteAt((struct CXTranslationUnitImpl*)p0, (char*)p1, p2, p3, (struct CXUnsavedFile*)p4, p5, p6);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge284 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1) {
    clang_sortCodeCompletionResults((CXCompletionResult*)p0, p1);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge285 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
...
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge288 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
    return (jlong)clang_codeCompleteGetContexts((CXCodeCompleteResults*)p0);
}
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge289 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge293 (JNIEnv* jniEnv, jclass jclss, jint p0) {
    clang_toggleCrashRecovery(p0);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge294 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge296 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
...
JNIEXPORT jdouble JNICALL Java_clang_clang_kniBridge301 (JNIEnv* jniEnv, jclass jclss, jlong p0) {
...
JNIEXPORT jlong JNICALL Java_clang_clang_kniBridge305 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge307 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2, jlong p3) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge311 (JNIEnv* jniEnv, jclass jclss, jint p0) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge322 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge325 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2, jint p3, jint p4, jlong p5, jlong p6, jint p7, jlong p8, jint p9, jlong p10, jint p11) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge327 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2, jint p3, jint p4, jlong p5) {
    return (jint)clang_indexTranslationUnit((void*)p0, (void*)p1, (IndexerCallbacks*)p2, p3, p4, (struct CXTranslationUnitImpl*)p5);
}
JNIEXPORT void JNICALL Java_clang_clang_kniBridge328 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1, jlong p2, jlong p3, jlong p4, jlong p5) {
...
JNIEXPORT jint JNICALL Java_clang_clang_kniBridge335 (JNIEnv* jniEnv, jclass jclss, jlong p0, jlong p1) {
...
JNIEXPORT void JNICALL Java_clang_clang_kniBridge337 (JNIEnv* jniEnv, jclass jclss, jlong p0, jint p1, jlong p2) {

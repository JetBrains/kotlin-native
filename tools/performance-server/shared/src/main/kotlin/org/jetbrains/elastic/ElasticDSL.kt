...
@DslMarker
annotation class ElasticDSLMarker

@ElasticDSLMarker
abstract class Element(val name: String): RenderableElement {

}

abstract class ObjectElement(name: String): Element(name)
abstract class ArrayElement(name: String): Element(name)

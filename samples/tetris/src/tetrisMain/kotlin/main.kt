...
fun main(args: Array<String>) {
    ...
    val width by argParser.option(ArgType.Int, shortName = "w", description = "Width of game field").default(Config.width)
    val height by argParser.option(ArgType.Int, shortName = "h", description = "Height of game field").default(Config.height)

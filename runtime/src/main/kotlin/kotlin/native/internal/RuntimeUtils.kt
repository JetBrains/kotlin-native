...
@PublishedApi
@ExportForCppRuntime
internal fun Konan_Byte_createInstance(value: Byte): Byte? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Short_createInstance(value: Short): Short? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Int_createInstance(value: Int): Int? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Long_createInstance(value: Long): Long? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Float_createInstance(value: Float): Float? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Double_createInstance(value: Double): Double? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Char_createInstance(value: Char): Char? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Boolean_createInstance(value: Boolean): Boolean? = value

@PublishedApi
@ExportForCppRuntime
internal fun Konan_Unit_createInstance(): Unit? = Unit
...
fun assertFalse(message: String?, block: () -> Boolean): Unit
        = assertFalse(block(), message)

/** Asserts that the [expected] value is equal to the [actual] value, with an optional [message]. */
fun <@kotlin.internal.OnlyInputTypes T> assertEquals(expected: T, actual: T, message: String?) : Unit
        = assertTrue(message) { expected == actual }

fun <@kotlin.internal.OnlyInputTypes T> assertEquals(expected: T, actual: T) : Unit
        = assertTrue(null) { expected == actual }

/** Asserts that the [actual] value is not equal to the illegal value, with an optional [message]. */
fun <@kotlin.internal.OnlyInputTypes T> assertNotEquals(illegal: T, actual: T, message: String?) : Unit
        = assertTrue(message) { illegal != actual }

/** Asserts that the [actual] value is not `null`, with an optional [message]. */
fun <T : Any> assertNotNull(actual: T?, message: String?): T {
...
fun <T : Any, R> assertNotNull(actual: T?, message: String?, block: (T) -> R) {

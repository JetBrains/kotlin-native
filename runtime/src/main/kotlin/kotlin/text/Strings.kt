 ...
 */
public actual fun String(chars: CharArray): String = unsafeFromCharArray(chars, 0, chars.size)
...
public actual fun String(chars: CharArray, offset: Int, length: Int): String {
    ...
    return unsafeFromCharArray(chars, offset, length)
}
 ...
 */
@SinceKotlin("1.3")
public actual fun CharArray.concatToString(): String = unsafeFromCharArray(this, 0, size)
...
public actual fun CharArray.concatToString(startIndex: Int, endIndex: Int): String {
    ...
    return unsafeFromCharArray(this, startIndex, endIndex - startIndex)
}
 ...
 */
@SinceKotlin("1.3")
public actual fun ByteArray.decodeToString(): String = unsafeStringFromUtf8Impl(0, size)
...
public actual fun ByteArray.decodeToString(startIndex: Int, endIndex: Int, throwOnInvalidSequence: Boolean): String {
    ...
    return if (throwOnInvalidSequence)
        unsafeStringFromUtf8OrThrowImpl(startIndex, endIndex - startIndex)
    else
        unsafeStringFromUtf8Impl(startIndex, endIndex - startIndex)
}
 ...
 */
@SinceKotlin("1.3")
public actual fun String.encodeToByteArray(): ByteArray = unsafeToUtf8Impl(0, length)
...
public actual fun String.encodeToByteArray(startIndex: Int, endIndex: Int, throwOnInvalidSequence: Boolean): ByteArray {
    checkBoundsIndexes(startIndex, endIndex, length)
    return if (throwOnInvalidSequence)
        unsafeToUtf8OrThrowImpl(startIndex, endIndex - startIndex)
    else
        unsafeToUtf8Impl(startIndex, endIndex - startIndex)
}

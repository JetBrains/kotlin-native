...
TYPED_TEST(FreezingNoHookTest, FreezeTreePermanentRoot) {
    TypeParam object;
    object.MakePermanent();
    TypeParam field1;
    TypeParam field2;
...
TYPED_TEST(FreezingNoHookTest, FreezeTreeRecursivePermanentRoot) {
    TypeParam object;
    object.MakePermanent();
    TypeParam inner1;
    TypeParam inner2;
...
TYPED_TEST(FreezingNoHookTest, FreezeTreeRecursivePermanentNode) {
    TypeParam object;
    TypeParam inner1;
...
TYPED_TEST(FreezingWithHookTest, FreezeTreePermanentRoot) {
    TypeParam object;
    object.MakePermanent();
    TypeParam field1;
    TypeParam field2;
...
TYPED_TEST(FreezingWithHookTest, FreezeTreeRecursivePermanentRoot) {
    TypeParam object;
    object.MakePermanent();
    TypeParam inner1;
    TypeParam inner2;
...
TYPED_TEST(FreezingWithHookTest, FreezeTreeRecursivePermanentNode) {
    TypeParam object;
    TypeParam inner1;
    inner1.MakePermanent();
    TypeParam inner2;
    ...
    inner2[0] = object.header();
    EXPECT_CALL(this->freezeHook(), Call(object.header()));
    EXPECT_CALL(this->freezeHook(), Call(inner1.header())).Times(0);

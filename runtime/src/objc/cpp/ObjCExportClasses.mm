...
static void injectToRuntime() {
  ...
  RuntimeCheck(Kotlin_ObjCExport_toKotlinSelector == nullptr, "%s", errorMessage);
  Kotlin_ObjCExport_toKotlinSelector = @selector(toKotlin:);

  RuntimeCheck(Kotlin_ObjCExport_releaseAsAssociatedObjectSelector == nullptr, "%s", errorMessage);
